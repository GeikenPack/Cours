...
/**
 * Décrivez votre classe ProgrammeEtudiant ici.
 *
 * @author (votre nom)
...
public class ProgrammeEtudiant
{
    ...
    {
        Adresse adr = new Adresse(32, "Rue de Malard", "Blagnac", "31700");
        afficheAdresse(adr);
        Etudiant tabInfo[];
    ...
    public static void afficheAdresse(Adresse adr)
    {
        System.out.println("Numéro rue : " + adr.numRue + ", nom de rue : " + adr.nomRue + ", code postal : " + adr.codePostal + ", ville : " + adr.ville);
    }
}
