...
public class AgenceBancaire {
	...
	/**
	 * Méthode privée de recherche de l'indice (rang) du Compte ayant un numéro recherché dans l'ArrayList alCptes.
	 * Cherche l'indice contenant un compte ayant pour numéro le numéro en paramètre.
	 * Renvoie -1 si aucun compte n'est trouvé.
	 *
	 * @param      pfNC  numéro du compte recherché
	 * @return     l'indice du Compte trouvé dans alCptes ayant pour numéro pfNC ou -1 si non trouvé. 
	 */
