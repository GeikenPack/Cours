    ...
    <div style="padding-top: 30px;" class="col-md-12">
        <ul class="nav nav-pills flex-column">
			...
			<?php
				...
				echo '<li class="nav-item">';
				if ($page == 'AjoutCategorie.php') {
					echo '<a class="nav-link active" href="AjoutCategorie.php?lien='.$_SERVER['PHP_SELF'].'">Ajouter une catégorie</a>';
				}
				else {
					echo '<a class="nav-link" href="AjoutCategorie.php?lien='.$_SERVER['PHP_SELF'].'">Ajouter une catégorie</a>';
				}
				echo '</li>';
