...
public class FrameSaisieMembre extends JFrame implements ActionListener
{
    ...
    private void gestionOK()
    {
    	if (isSaisieCorrecte())
    	{
    		...
    		//Création du membre et affichage
    ...
    private boolean isSaisieCorrecte()
    {
    	...
    	{
    		System.out.println("Prénom invalide. Le prénom doit posseder plus de deux lettres et ne doit pas commencer ou finir par un espace"); 
    		correct = false;
    	}
    	return correct;
    }
